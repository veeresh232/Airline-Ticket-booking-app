...
<body
	...
	<div class="Action Table" style="color: black;">
		...
		<br> <br>
		<center><h6>View</h6><h3>Your Bookings</h3></center>
				...
				<table class="table" id="customers" border="0px"
					...
					%>
					 <tr style=" font-weight:bold;height: 75px;"  >
						...
						<td><form action="ticket.jsp"><input type='hidden' name='tripId' value=<%=tripId%> />
						<input type="submit" value="View Ticket"/></form></td> 
					...
					%> 
<center> <h2>No Bookings</h2></center>
<%} %>
